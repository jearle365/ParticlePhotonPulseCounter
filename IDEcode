...
// Change these for each Installation
////////////////////////////////////////////////////
...
if (millis() - previousEEPROM >= eepromInterval ) {      // Write to EEPROM every HOUR, Day, etc. cannot make the same at the publish interval
